define(
  ...
  {
    describe("KOANS FOR STEP 4: We must add a getScavs call to our application services layer (ServicesAdapter) with some success and failure callbacks, and store the scavs as a ScavCollection on a public accessor.", function() {
