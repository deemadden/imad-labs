define(
  ...
  function (App, ScavItemsViewModel, ServicesAdapter, Scav, CSSHelper, Debug)
  {
    describe("ScavItemViewModel unit tests", function() {
      ...
      afterEach(function() {
        // TODO: Clear out the scav set on the ServiceAdapter's selectedScav property
    ...
    function thenDataNeededByViewIsReturned()
    {
      ...
      // TODO: Assert that CSSHelper's getBackgroundURLPathForAnchor method was called 11 times.
    ...
    var expectedViewData = "foo";
    var actualViewData = "bar";
