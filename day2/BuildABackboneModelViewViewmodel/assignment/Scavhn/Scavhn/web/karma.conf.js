...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'spec/KoansForStep1_ServicesManagerIntegrationSpec.js', included: false},
      //{pattern: 'spec/KoansForStep2_ScavUnitSpec.js', included: false},
      //{pattern: 'spec/KoansForStep3_ScavCollectionUnitSpec.js', included: false},
      //{pattern: 'spec/KoansForStep4_ServicesAdapterUnitSpec.js', included: false},
      //{pattern: 'spec/KoansForStep5_HomeScreenViewModelUnitSpec.js', included: false},
      //{pattern: 'spec/KoansForStep6_HomeScreenViewUnitSpec.js', included: false},
      //{pattern: 'spec/UnitTestLab_ScavItemsViewModelUnitSpec.js', included: false},
      'spec/test-main.js'
    ],
